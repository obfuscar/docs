# -*- coding: utf-8 -*-
#
# obfuscar documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'obfuscar.tex', u'Obfuscar Documentation',
   u'Ryan Williams, Calvin Rien, Lex Li, RemObjects Software, and other contributors', 'manual'),
]
...
man_pages = [
    (master_doc, 'obfuscar', u'Obfuscar Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'obfuscar', u'Obfuscar Documentation',
   author, 'obfuscar', 'Obfuscar Documentation',
   '.NET MSIL Obfuscation'),
]
...
def setup(app):
    ...
    if not on_rtd:
        ...
        """
        app.add_js_file("https://www.googletagmanager.com/gtag/js?id=UA-1962620-16")
